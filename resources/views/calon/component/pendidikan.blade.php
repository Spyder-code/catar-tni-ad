<div class="form-group row">
    <div class="col-lg-4 col-6 col-md-3">
        ...
        @enderror
        <input type="text" pattern="[a-zA-Z0-9]*" style="text-transform: uppercase" @error('pendidikan.sd') autofocus @enderror name="pendidikan[sd]" class="form-control" value="{{ $pendidikan!=null?stripcslashes($pendidikan->sd) : old('pendidikan.sd') }}">
    </div>
    <div class="col-lg-4 col-6 col-md-3">
    ...
    <div class="col-lg-4 col-6 col-md-3">
        ...
        @enderror
        <input type="text" pattern="[a-zA-Z0-9]*" style="text-transform: uppercase" @error('pendidikan.kab_sd') autofocus @enderror name="pendidikan[kab_sd]" class="form-control" value="{{ $pendidikan!=null?stripcslashes($pendidikan->kab_sd) : old('pendidikan.kab_sd') }}">
    </div>
</div>
<div class="form-group row">
    <div class="col-lg-4 col-6 col-md-3">
        ...
        @enderror
        <input type="text" pattern="[a-zA-Z0-9]*" style="text-transform: uppercase" @error('pendidikan.smp') autofocus @enderror name="pendidikan[smp]" class="form-control" value="{{ $pendidikan!=null?stripcslashes($pendidikan->smp) : old('pendidikan.smp') }}">
    </div>
    <div class="col-lg-4 col-6 col-md-3">
    ...
    <div class="col-lg-4 col-6 col-md-3">
        ...
        @enderror
        <input type="text" pattern="[a-zA-Z0-9]*" style="text-transform: uppercase" @error('pendidikan.kab_smp') autofocus @enderror name="pendidikan[kab_smp]" class="form-control" value="{{ $pendidikan!=null?stripcslashes($pendidikan->kab_smp) : old('pendidikan.kab_smp') }}">
    </div>
</div>
<div class="form-group row">
    <div class="col-sm">
        ...
        @enderror
        <input type="text" pattern="[a-zA-Z0-9]*" style="text-transform: uppercase" @error('pendidikan.sma') autofocus @enderror name="pendidikan[sma]" class="form-control" value="{{ $pendidikan!=null?stripcslashes($pendidikan->sma) : Auth::guard('calon')->user()->nama_sekolah }}">
    </div>
    <div class="col-sm">
        <label>Jurusan</label>
        ...
        @enderror
        <input type="text" pattern="[a-zA-Z0-9]*" style="text-transform: uppercase" name="pendidikan[jur]" class="form-control" value="{{ $pendidikan!=null?$pendidikan->jur :  Auth::guard('calon')->user()->jur }}">
    </div>
    <div class="col-lg-3 col-6 col-md-3">
        ...
        @enderror
        <input type="text" pattern="[a-zA-Z0-9]*" style="text-transform: uppercase" @error('pendidikan.kab_sma') autofocus @enderror name="pendidikan[kab_sma]" class="form-control" value="{{ $pendidikan!=null?stripcslashes($pendidikan->kab_sma) : old('pendidikan.kab_sma') }}">
    </div>
    <div class="col-sm-2">
