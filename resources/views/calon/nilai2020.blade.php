...
<div class="tg-wrap">
    ...
    <tr>
        ...
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bipeng1 :old('nilai.bipeng1') }}" step="any" name="nilai[bipeng1]" id="ind1"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->biket1 :old('nilai.biket1') }}" step="any" name="nilai[biket1]" id="ind2"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bipeng2 :old('nilai.bipeng2') }}" step="any" name="nilai[bipeng2]" id="ind3"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->biket2 :old('nilai.biket2') }}" step="any" name="nilai[biket2]" id="ind4"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bipeng3 :old('nilai.bipeng3') }}" step="any" name="nilai[bipeng3]" id="ind5"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->biket3 :old('nilai.biket3') }}" step="any" name="nilai[biket3]" id="ind6" ></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bipeng4 :old('nilai.bipeng4') }}" step="any" name="nilai[bipeng4]" id="ind7"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->biket4 :old('nilai.biket4') }}" step="any" name="nilai[biket4]" id="ind8"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bipeng5 :old('nilai.bipeng5') }}" step="any" name="nilai[bipeng5]" id="ind9"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->biket5 :old('nilai.biket5') }}" step="any" name="nilai[biket5]" id="ind10"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bipeng6 :old('nilai.bipeng6') }}" step="any" name="nilai[bipeng6]" id="ind11"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->biket6 :old('nilai.biket6') }}" step="any" name="nilai[biket6]" id="ind12"></td>
    </tr>
    <tr>
        <td class="tg-c3ow">2</td>
        <td class="tg-c3ow">matematika</td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkpeng1 :old('nilai.mtkpeng1') }}" step="any" name="nilai[mtkpeng1]" id="mtk1"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkket1 :old('nilai.mtkket1') }}" step="any" name="nilai[mtkket1]" id="mtk2"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkpeng2 :old('nilai.mtkpeng2') }}" step="any" name="nilai[mtkpeng2]" id="mtk3"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkket2 :old('nilai.mtkket2') }}" step="any" name="nilai[mtkket2]" id="mtk4"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkpeng3 :old('nilai.mtkpeng3') }}" step="any" name="nilai[mtkpeng3]" id="mtk5"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkket3 :old('nilai.mtkket3') }}" step="any" name="nilai[mtkket3]" id="mtk6"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkpeng4 :old('nilai.mtkpeng4') }}" step="any" name="nilai[mtkpeng4]" id="mtk7"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkket4 :old('nilai.mtkket4') }}" step="any" name="nilai[mtkket4]" id="mtk8"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkpeng5 :old('nilai.mtkpeng5') }}" step="any" name="nilai[mtkpeng5]" id="mtk9"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkket5 :old('nilai.mtkket5') }}" step="any" name="nilai[mtkket5]" id="mtk10"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkpeng6 :old('nilai.mtkpeng6') }}" step="any" name="nilai[mtkpeng6]" id="mtk11"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->mtkket6 :old('nilai.mtkket6') }}" step="any" name="nilai[mtkket6]" id="mtk12"></td>
    </tr>
    <tr>
        <td class="tg-c3ow">3</td>
        <td class="tg-c3ow">B. Inggris</td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigpeng1 :old('nilai.bigpeng1') }}" step="any" name="nilai[bigpeng1]" id="ing1"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigket1 :old('nilai.bigket1') }}" step="any" name="nilai[bigket1]" id="ing2"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigpeng2 :old('nilai.bigpeng2') }}" step="any" name="nilai[bigpeng2]" id="ing3"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigket2 :old('nilai.bigket2') }}" step="any" name="nilai[bigket2]" id="ing4"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigpeng3 :old('nilai.bigpeng3') }}" step="any" name="nilai[bigpeng3]" id="ing5"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigket3 :old('nilai.bigket3') }}" step="any" name="nilai[bigket3]" id="ing6"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigpeng4 :old('nilai.bigpeng4') }}" step="any" name="nilai[bigpeng4]" id="ing7"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigket4 :old('nilai.bigket4') }}" step="any" name="nilai[bigket4]" id="ing8"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigpeng5 :old('nilai.bigpeng5') }}" step="any" name="nilai[bigpeng5]" id="ing9"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigket5 :old('nilai.bigket5') }}" step="any" name="nilai[bigket5]" id="ing10"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigpeng6 :old('nilai.bigpeng6') }}" step="any" name="nilai[bigpeng6]" id="ing11"></td>
        <td class="tg-c3ow"><input class="input" type="number" onkeypress="return this.value.length < 5;" oninput="if(this.value.length>=5) { this.value = this.value.slice(0,5); }" value="{{ $nilai!=null?$nilai->bigket6 :old('nilai.bigket6') }}" step="any" name="nilai[bigket6]" id="ing12"></td>
    </tr>
    <tr>
