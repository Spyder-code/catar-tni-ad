    ...
    public function rules()
    {
        if (env('PONPES')) {
            return [
                ...
                'calon.inst' => 'nullable',
                'calon.face' => 'nullable',
                'calon.tiktok' => 'nullable',
                'calon.twiter' => 'nullable',
                'pendidikan.nisnsd' => 'required|min:10',
                'pendidikan.nisnsmp' => 'required|min:10',
                'pendidikan.nisnsma' => 'required|min:10',
                ...
                'pendidikan.ponpes' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                ...
                'wali.a_kakek_almt_skr' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.a_kakek_almt_sblm' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.a_nenek' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.a_nenek_almt_skr' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.a_nenek_almt_sblm' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                ...
                'wali.i_kakek_almt_skr' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.i_kakek_almt_sblm' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.i_nenek' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.i_nenek_almt_skr' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'wali.i_nenek_almt_sblm' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
            ...
            return [
                ...
                'calon.tiktok' => 'nullable',
                'calon.twiter' => 'nullable',
                'pendidikan.nisnsd' => 'required',
                'pendidikan.nisnsmp' => 'required',
                'pendidikan.nisnsma' => 'required',
                'pendidikan.sd' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'pendidikan.l_sd' => 'required',
                'pendidikan.kab_sd' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
                'pendidikan.smp' => 'required|regex:/^[a-zA-Z0-9 .,-\/\(\)]+$/',
